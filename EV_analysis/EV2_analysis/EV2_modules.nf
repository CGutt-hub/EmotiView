...
include { IOInterface as sam_pivot          } from '../../../AnalysisToolbox/gitatbx/bin/workflow_wrapper.nf'
include { IOInterface as sam_bootstrap      } from '../../../AnalysisToolbox/gitatbx/bin/workflow_wrapper.nf'
...
// L2 group-level LMM (lmm_analyzer, multi-participant collected input)
include { IOInterface as eda_l2_lmm_analyzer      } from '../../../AnalysisToolbox/gitatbx/bin/workflow_wrapper.nf'
include { IOInterface as hrv_l2_lmm_analyzer      } from '../../../AnalysisToolbox/gitatbx/bin/workflow_wrapper.nf'
include { IOInterface as fai_l2_lmm_analyzer      } from '../../../AnalysisToolbox/gitatbx/bin/workflow_wrapper.nf'
...
// L2 EEG band-power group LMM (mirrors EDA/HRV/FAI L2 analyses)
include { IOInterface as eeg_frontal_l2_lmm_analyzer  } from '../../../AnalysisToolbox/gitatbx/bin/workflow_wrapper.nf'
include { IOInterface as eeg_parietal_l2_lmm_analyzer } from '../../../AnalysisToolbox/gitatbx/bin/workflow_wrapper.nf'
include { IOInterface as l2_lmm_consolidator          } from '../../../AnalysisToolbox/gitatbx/bin/workflow_wrapper.nf'

// L2 cross-participant WP2 (correl --consolidate-l2)
include { IOInterface as wp2_l2_correl       } from '../../../AnalysisToolbox/gitatbx/bin/workflow_wrapper.nf'

// L2 cross-modal WP3 + WP4 (LMM on combined binned data — accounts for individual differences)
include { IOInterface as wp3_l2_lmm          } from '../../../AnalysisToolbox/gitatbx/bin/workflow_wrapper.nf'
include { IOInterface as wp4_l2_lmm          } from '../../../AnalysisToolbox/gitatbx/bin/workflow_wrapper.nf'
